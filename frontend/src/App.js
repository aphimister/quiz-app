      ...
      <>
        <BrowserRouter>
          ...
          <Switch>
            ...
            <Route exact path="/" render={props => <Home diffHandler = {this.diffHandler} catHandler = {this.catHandler} state={this.state} category={this.state.category} difficulty={this.state.difficulty}/>} />
            <Route exact path="/login" component={Login} />
            <Route exact path="/logout" component={Logout} />
            <Route exact path="/register" component={Register} />
            <Route exact path="/quiz" component={QuizPage} render={props => <QuizPage category={this.state.category} difficulty={this.state.difficulty}/>}/>
          </Switch>
        </BrowserRouter>
      </>
    );
